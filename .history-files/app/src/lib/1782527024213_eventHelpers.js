...
export const BG_PATTERNS = [
  ...
  // ─── Fondos animados ─────────────────────────────────────────────────
  // Requieren @keyframes iv-* definidos en index.css
  // Usan color-mix() con CSS variables de paleta: --color-accent, --color-primary, --color-surface
  // Se adaptan automáticamente a cualquier paleta del evento — sin hardcode.
  {
    ...
    style: {
      background: [
        ...
        '  color-mix(in srgb, var(--color-primary) 12%, transparent) 35%,',
        '  color-mix(in srgb, var(--color-surface) 80%, transparent) 65%,',
        '  color-mix(in srgb, var(--color-accent)  18%, transparent) 100%)',
      ].join(''),
      backgroundSize: '300% 300%',
      animationName: 'iv-aurora', animationDuration: '10s',
  ...
  },
  {
    ...
    style: {
      ...
      backgroundImage: [
        'radial-gradient(circle, color-mix(in srgb, var(--color-accent)  55%, transparent) 1px, transparent 1px),',
        'radial-gradient(circle, color-mix(in srgb, var(--color-accent)  28%, transparent) 1px, transparent 1px),',
        'radial-gradient(circle, color-mix(in srgb, var(--color-primary) 18%, transparent) 1px, transparent 1px)',
      ].join(' '),
      backgroundSize: '48px 48px, 72px 72px, 36px 36px',
      backgroundPosition: '0px 0px, 24px 24px, 12px 12px',
      animationName: 'iv-sparkle', animationDuration: '7s',
      animationTimingFunction: 'ease-in-out', animationIterationCount: 'infinite',
    },
  },
  {
    ...
    style: {
      ...
      backgroundImage: [
        ...
        '  color-mix(in srgb, var(--color-accent)  8%, transparent) 18px,',
        '  color-mix(in srgb, var(--color-accent)  8%, transparent) 19px),',
        'repeating-linear-gradient(0deg, transparent, transparent 37px,',
        '  color-mix(in srgb, var(--color-primary) 5%, transparent) 37px,',
        '  color-mix(in srgb, var(--color-primary) 5%, transparent) 38px)',
      ].join(' '),
      animationName: 'iv-ondas', animationDuration: '3s',
  ...
  },
  {
    ...
    style: {
      background: [
        'radial-gradient(ellipse at 25% 35%, color-mix(in srgb, var(--color-accent)  26%, transparent) 0%, transparent 55%),',
        'radial-gradient(ellipse at 75% 65%, color-mix(in srgb, var(--color-primary) 16%, transparent) 0%, transparent 55%),',
        'var(--color-surface)',
      ].join(' '),
      animationName: 'iv-bruma', animationDuration: '5s',
      animationTimingFunction: 'ease-in-out', animationIterationCount: 'infinite',
